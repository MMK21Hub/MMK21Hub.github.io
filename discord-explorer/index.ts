...
let messages: Array<message> = [
    {
        ...
        author: {
            ...
            isBot: false,
            avatarUrl:
                "https://cdn.discordapp.com/avatars/325691401851633674/cb3ebb9ce8caca16407dfc9bf00127c0.png",
        },
        attachments: [],
        embeds: [],
        reactions: [],
    ...
    },
    {
        ...
        isPinned: false,
        content:
            "Add a message every day in a #motd channel with a random command fact that could be useful or inspire people. For example \u0027you can use /replaceitem to put an item into a specific slot in someone\u0027s inventory\u0027 or \u0027the /effect command has an option to show or hide particles\u0027",
        author: {
            ...
            isBot: false,
            avatarUrl:
                "https://cdn.discordapp.com/avatars/646445858233122843/3bd25f90e1cf9fad0877556ba94586cc.png",
        },
        attachments: [],
        embeds: [],
        reactions: [
